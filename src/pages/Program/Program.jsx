...
export default function Program() {
  ...
  return (
    <div className="container mx-auto bg-no-repeat md:mt-20" style={programBg}>
      <div className="pt-10 pb-10 bg-white bg-opacity-50 md:pt-20">
        <div className="flex justify-center">
          <h1 className="md:p-2.5 p-1.5 bg-[#ED1B24] text-white md:text-4xl text-2xl font-extrabold inline-block">
            PROGRAM
          </h1>
        </div>
        <p className="text-center text-black md:text-[44px] text-2xl font-bold mt-4">
          Menuju Denpasar yang Lebih Baik
        </p>
        <div className="container grid grid-cols-1 gap-8 mx-auto mt-16 mb-5 md:grid-cols-3 md:w-5/6">
          <ProgramCard
